...
public class DrawBatch {
    ...
    public void renderBatch(){
        ...
        while(!images.isEmpty()){
            ...
            glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, Preferences.interpolation() ? GL_LINEAR : GL_NEAREST);
            glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, Preferences.interpolation() ? GL_LINEAR : GL_NEAREST);
