...
import sauce.util.structures.special.PriorityMap;
import sauce.util.structures.special.SortedArrayList;
...
public final class Engine {
    ...
    public static <T extends EngineSystem> T remove(Class<T> sys) {
        if (GUISystem.class.isAssignableFrom(sys)) {
            ...
            if (ret == null) {
                RSauceLogger.printWarningln("EngineSystem " + sys.getSimpleName() + " was not found in core");
                return null;
            }
    ...
    public static void remove(Entity ent){
        if(!entities.contains(ent)){
            RSauceLogger.printWarningln("Entity was not found in core");
            return;
        }
    ...
    private static class RenderSystem extends EngineSystem implements EntitySubscriber{
        ...
        public static class ZComparator implements Comparator<Entity>{
            ...
            public int compare(Entity o1, Entity o2) {
                return o2.getComponent(SpriteComponent.class).getZ() - o1.getComponent(SpriteComponent.class).getZ();
            }
        }
    }
